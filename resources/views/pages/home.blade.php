...
@section('content')
    ...
    <div class="col-md-6 videoshow">
        ...
        <a href="{{route('pages.restaurant')}}/#section_bookonline">book a table online</a> now.</p>	
    ...
    <div class="col-md-6 videoshow">
        ...
        <p class="info">Master chef's techniques to make perfect stir-fries, balanced curries and dinner party dishes that will wow your friends.<a href="{{route('pages.school')}}">Visit the cooking school page</a> to view classes and make bookings.</p>
    </div>    
@endsection
